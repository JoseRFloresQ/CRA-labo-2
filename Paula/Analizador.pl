...
test_11:- oracion(X,[juan,y,'maría',comen,la,manzana,roja,con,un,tenedor,y,un,cuchillo],[]),draw(X). %funciona
test_12:- oracion(X,['maría',hace,la,'práctica',de,juan],[]),draw(X).                                   %funciona
test_13:- oracion(X,[mi,casa,'está',muy,lejos,de,madrid],[]),draw(X).                                 %funciona
...
test_17:- oracion(X,[esta,noche,'saldré',por,'alcalá'],[]),draw(X).                                       %funciona
test_18:- oracion(X,[la,esperanza,de,la,vida,de,un,'niño',depende,de,su,lugar,de,nacimiento],[]),draw(X). %funciona
...
test15:- oracion(X,[juan,recoge,la,mesa,mientras,maría,toma,un,café],[]),draw(X).  %correcto
...
%oraciónes apartado 3
test01:- oracion(X,[juan,es,moreno,y,'maría',es,alta],[]),draw(X).  %correcto
test02:- oracion(X,[juan,estudia,'filosofía',pero,'maría',estudia,derecho],[]),draw(X). %correcto
...
test013:- oracion(X,[el,'ratón',que,'cazó',el,gato,era,gris],[]),draw(X). %correcto
