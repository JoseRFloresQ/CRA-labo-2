...
% cuando hay dos coordinadas, una con sujeto y otra sin, luego otra con sujeto y otra sin, y luego otra con sujeto
simplificacion_coordinada(o(ocm(oc(o(os(suj(Suj1),pred(Pred1))),c(_), o(ocm(oc(o(os(pred(Pred2))),c(_), o(ocm(oc(o(os(suj(Suj2),pred(Pred3))),c(_), o(ocm(oc(o(os(pred(Pred4))),c(_), o(os(suj(Suj3),pred(Pred5))) ))) ))) ))) ))), [o(os(suj(Suj1),pred(Pred1))) ,o(os(suj(Suj1),pred(Pred2))) ,o(os(suj(Suj2),pred(Pred3))) ,o(os(suj(Suj2),pred(Pred4))) ,o(os(suj(Suj3),pred(Pred5))) ]).
